...
// ==============================================================
// VOLTSHIELD X : CUSTOM SOVEREIGN HARDWARE DEFINITION (N16R8)
// ==============================================================
#if defined(VOLTSHIELD_X)
...
// ==============================================================
// نهاية قسم VOLTSHIELD X - بداية بوردات الـ Launcher الأصلية
// ==============================================================
#else 
...
#endif // END OF ORIGINAL CODE BLOCK
#endif // VOLTSHIELD_X
#endif //__TFT_H
